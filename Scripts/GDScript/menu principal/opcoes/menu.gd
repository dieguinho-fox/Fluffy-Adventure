...
func check_for_updates() -> void:
	...
	var err: int = http.request(update_url + "?t=" + str(Time.get_unix_time_from_system()))
	if err != OK:
		show_error()
...
func _on_request_completed(result: int, response_code: int, _headers: PackedStringArray, body: PackedByteArray) -> void:
	...
	var latest_version: String = "ERRO"
...
func _iniciar_novo_jogo() -> void:
	...
	var file: FileAccess = FileAccess.open(VIDAS_SAVE_PATH, FileAccess.WRITE)
	if file:
...
func _enviar_suporte():
	...
	var corpo: String = "Descreva seu problema:\n\nCole o log aqui ou envie o arquivo .log\n\n"
